<?php bunch_global_variable(); 
	...
	$layout = teclus_set( $settings, 'author_page_layout', 'right' );
	$sidebar = teclus_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
	$view = teclus_set( $settings, 'author_page_view', 'list' );
	...
	$bg = teclus_set($settings, 'author_page_header_img');
	$title = teclus_set($settings, 'author_page_header_title');
?>
<!--Page Title-->
