...
teclus_vc_map( array(
			...
			"name" => esc_html__("bbPress Forums", 'teclus'),

			"base" => "bbp-forum-index",

			"class" => "",

			"category" => esc_html__('Jollyall', 'teclus'),
			...
			"params" => array(				
				...
				array(
				   ...
				   "heading" => esc_html__("Forum", 'teclus'),
...
function vc_theme_vc_row($atts, $content = null) {
   ...
   extract(shortcode_atts(array(
	...
	//$boxed = teclus_set( _WSH()->option(), 'boxed_layout' );
...
$param = array(
  ...
  "heading" => esc_html__("Container", 'teclus'),

  "param_name" => "container",

  "value" => array('Center Page'=>true),

  "description" => esc_html__("Choose whether you want to add a container before row or not.", 'teclus')
